namespace EmployeeManagement.Resources
{
    internal static class TextData
    {
        ...
        public static string EntityListEmpty { get; } = "Упс, список пуст, возможно вы ничего не добавили в файл!";
        public static string MainMenuInputFail { get; } = "Ошибка, попробуйте еще раз!";
    }
}
